...
public class CountryConverter implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if (value != null && value.trim().length() > 0) {
            try {
                CountryService service = (CountryService) fc.getExternalContext().getApplicationMap().get("countryService");

                return service.getCountryByCountryId(Integer.parseInt(value));
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        if (object != null) {
            return String.valueOf(((Country) object).getCountryId());
        } else {
            return null;
        }
    }
